 ...
 * @author Acer
 */
public class TravelerReviewsView extends javax.swing.JFrame {

    /**
     * Creates new form AdmindashboardView
     */
    public TravelerReviewsView() {
        initComponents();
        scaleImage1();
        scaleImage2();
        scaleImage3();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TravelerReviewsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TravelerReviewsView().setVisible(true);
            }
        });
    }
