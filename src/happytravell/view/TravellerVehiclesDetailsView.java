...
public class TravellerVehiclesDetailsView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        numberOfSeatsTextField1 = new javax.swing.JTextField();
        jComboBox1 = new javax.swing.JComboBox<>();
        vehiclePhoto = new javax.swing.JLabel();
        ...
        jLabel6.setText("Vehicles Name");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, -1, 30));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Vehicles Color");
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 230, 90, 30));
        jPanel3.add(numberOfSeatsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 230, 220, 30));
        ...
        jPanel3.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, -1, 30));
        jPanel3.add(numberOfSeatsTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 180, 220, 30));

        ProfilePanel.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, 500, 280));

        jComboBox1.setBackground(new java.awt.Color(252, 186, 107));
        jComboBox1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Vehicles", "Car", "Jeep", "Taxi", "Bus" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        ProfilePanel.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 80, -1, -1));

        vehiclePhoto.setText("View vehicle");
        ProfilePanel.add(vehiclePhoto, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 86, 430, 210));
    ...
    private javax.swing.JTextField numberOfSeatsTextField1;
    ...
    private javax.swing.JLabel vehiclePhoto;
    ...
    public JTextField getNumberOfSeatsTextField1() {
    return numberOfSeatsTextField1;
    }

    public JLabel getVehiclePhotoLabel() {
        return vehiclePhoto;
    }
