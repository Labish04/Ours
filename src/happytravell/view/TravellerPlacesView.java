 ...
 * @author Acer
 */
public class TravellerPlacesView extends javax.swing.JFrame {

    /**
     * Creates new form AdmindashboardView
     */
    public TravellerPlacesView() {
        initComponents();
        scaleImage1();
        scaleImage2();
        scaleImage3();
    ...
    private void initComponents() {
        ...
        bookingDetailsLabel.setText("  Booking ");
        ...
        routeDetailsLabel.setText("  Route ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TravellerPlacesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TravellerPlacesView().setVisible(true);
            }
        });
    }
